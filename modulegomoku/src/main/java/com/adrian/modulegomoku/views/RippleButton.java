...
public class RippleButton extends AppCompatButton {
    ...
    public RippleButton(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.modulegomoku_RippleButton);
        mRippleColor = a.getColor(R.styleable.modulegomoku_RippleButton_modulegomoku_rippleColor,
                mRippleColor);
        mAlphaFactor = a.getFloat(R.styleable.modulegomoku_RippleButton_modulegomoku_alphaFactor,
                mAlphaFactor);
        mHover = a.getBoolean(R.styleable.modulegomoku_RippleButton_modulegomoku_hover, mHover);
        a.recycle();
    }
