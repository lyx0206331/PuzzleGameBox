...
/**
 * Created by ranqing on 2017/1/1.
 */
...
public class MultipleRadioGroup extends LinearLayout {
    ...
    public MultipleRadioGroup(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new MultipleRadioGroup.LayoutParams(getContext(), attrs);
    }
    ...
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof MultipleRadioGroup.LayoutParams;
    }
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(MultipleRadioGroup.class.getName());
    }

    @Override
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        super.onInitializeAccessibilityNodeInfo(info);
        info.setClassName(MultipleRadioGroup.class.getName());
    }
    ...
    private class PassThroughHierarchyChangeListener implements
        ...
        public void onChildViewAdded(View parent, View child) {
            if (parent == MultipleRadioGroup.this) {
                List<RadioButton> btns = getAllRadioButton(child);
                if (btns != null && btns.size() > 0) {
